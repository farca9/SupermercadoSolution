...
import frsf.cidisi.exercise.agentesupermercado.search.actions.MoveUp;
import frsf.cidisi.exercise.agentesupermercado.search.actions.MoveDown;
import frsf.cidisi.exercise.agentesupermercado.search.actions.MoveRight;
import frsf.cidisi.exercise.agentesupermercado.search.actions.MoveLeft;
import frsf.cidisi.exercise.agentesupermercado.search.actions.EntrarSupermercado;
import frsf.cidisi.exercise.agentesupermercado.search.actions.SalirSupermercado;
import frsf.cidisi.exercise.agentesupermercado.search.actions.ComprarProducto;
